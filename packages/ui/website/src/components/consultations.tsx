...
const Services = () => {
  let services = [
    ...
    //   description: "Type-2 diabetes routine check up",
    //   type: "Group",
    //   time: "11:AM IST",
    //   location: "Sydney",
    //   slots: "8/10",
    ...
    >
      ...
      >
        ...
        <Typography variant="subtitle1" style={{ margin: 30 }}>
          ...
          consultations are created by medical practitioners to support people
          in time of crisis.
        </Typography>
      </Grid>
      ...
      <Grid item xs={12}>
        {services.length ? (
          ...
          >
            <Button variant="outlined" color="primary" size="large">
              No Available Consultations. Please join patient waitlist
            </Button>
          </Link>
        )}
      </Grid>
