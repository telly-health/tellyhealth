...
`telly.health` will enalbe healthcare professionals across the globe to create telehealth webinar, group consultation and one-to-one consultation for people in need through our platform that could simultaneously save time and support people during crisis.
